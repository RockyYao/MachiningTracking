...
<div class="app-body">
    ...
    <main class="main">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">角色修改</li>
        </ol>
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <strong style="font-size:17px;font-weight:700;vertical-align: -1px;margin-right:5px">☰</strong>角色修改
                </div>
                <div class="card-block">
                    <form id="mainForm" method="post" class="form-horizontal" action="${basePath}/role/editRole.htm">
                        <input type="hidden" name="id" value="${role.id}">
                        <div class="form-group row">
                            <label class="col-sm-2 form-control-label l_class" for="name">角色名称</label>
                            <div class="col-sm-6  goods_but ">
                                <input type="text" id="name" name="name" class="form-control"
                                value="${role.name}" maxlength="50">
                ...
                <div class="card-footer">
                    <button id="submitBtn" type="submit" class="btn btn-sm btn-primary" onclick="editRole()"><i
