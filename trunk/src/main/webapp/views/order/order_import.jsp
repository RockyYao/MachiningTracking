...
<div class="app-body">
    ...
    <main class="main">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">导入订单Excel</li>
        </ol>
                ...
                <div class="card-block">
                    <form id="mainForm" method="post" class="form-horizontal" enctype="multipart/form-data">
                        <div class="form-group row">
                            <label class="col-sm-2 form-control-label l_class" for="fileToUpload">选择文件</label>
...
<script>
    ...
    function ajaxFileUpload(){
        ...
        $.ajaxFileUpload({
            url:'${basePath}/order/importOrder.htm',
            type:'post',
            secureuri:false,
