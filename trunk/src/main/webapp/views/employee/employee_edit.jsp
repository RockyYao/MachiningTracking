    ...
    <main class="main">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="${basePath}/user/userList.htm">员工管理</a>
            </li>
        ...
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-block">
                    <form id="mainForm" method="post" class="form-horizontal" action="${basePath}/employee/editEmployee.htm"
                    enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6  goods_but " style="margin-left: 35px">
                                <input type="text" id="workNo" name="workNo" class="form-control" maxlength="50" value="${employee.workNo}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 form-control-label l_class" for="workName">姓名</label>
                            <div class="col-sm-6  goods_but " style="margin-left: 35px">
                                <input type="text" id="workName" name="name" class="form-control" maxlength="50" value="${employee.name}" readonly>
                            </div>
                        </div>
                        <c:forEach items="${employee.employeeProcedureList}" var="procedure" varStatus="vs">
                            <div class="form-group row">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <label class="col-sm-2 form-control-label l_class"></label>
                                            <div>
                                                <span class="count-up" onclick="reduceInput(this)">-</span>
                                        </c:otherwise>
                                    </c:choose>
                                </div>
                                <div class="col-sm-6  goods_but " style="margin-left: 5px">
                                    <input type="text" name="pName" class="form-control" maxlength="50" value="${procedure.procedureName}">
                                </div>
                            </div>
                        </c:forEach>
                    </form>
                ...
                <div class="card-footer">
                    <button id="submitBtn" type="submit" class="btn btn-sm btn-primary" onclick="editEmployee()"><i
