    ...
    <main class="main">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="${basePath}/user/userList.htm">用户管理</a>
            </li>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <strong style="font-size:17px;font-weight:700;vertical-align: -1px;margin-right:5px">☰</strong>用户添加
                </div>
                <div class="card-block">
                    <form id="mainForm" method="post" class="form-horizontal" action="${basePath}/user/addUser.htm"
                    enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 form-control-label l_class" for="userName">用户名</label>
                            <div class="col-sm-6  goods_but ">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 form-control-label l_class" for="password">密码</label>
                            <div class="col-sm-6  goods_but ">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 form-control-label l_class" for="rePassword">确认密码</label>
                            <div class="col-sm-6  goods_but ">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 form-control-label l_class">头像</label>
                            <div class="col-sm-6  goods_but ">
                                <div class="ncsc-upload-thumb store-logo">
                                    <p>
                                        <img id="preview" style="width: 150px;height: 150px" src="${basePath}/resources/img/u18523.png"/>
                                    </p>
                                </div>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 form-control-label l_class" for="enName">英文名</label>
                            <div class="col-sm-6  goods_but ">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 form-control-label l_class" for="chName">中文名</label>
                            <div class="col-sm-6  goods_but ">
                                <input type="text" id="chName" name="chName" class="form-control" maxlength="50">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 form-control-label l_class">性别</label>
                            <div class="col-sm-6  goods_but ">
                                <input type="radio" name="gender" value="1" style="margin-top: 15px" checked="checked">男
                                <input type="radio" name="gender" value="2" style="margin-left: 10%">女
                            </div>
                        </div>
                    </form>
                </div>
    ...
    function saveUser() {
        if (check()) {
            $.ajax({
                ...
                type:'post',
                data:{"userName":$("#userName").val(),"workNo":$("#workNo").val()},
                dataType:'json',
